...
// FIXME: надо проверять, что регистр не зависит от предыдущего значения этой регистровой переменной!
// Например, достаточно, чтобы ранее этой инструкции регистровая переменная не использовалась в этой функции.
