...
typedef enum x86_instruction_code_decl {
    ...
    x86insn_int_sub,
    x86insn_int_imul,
    x86insn_int_idiv,           // первый параметр - псевдорегистр дл€ EAX, второй - делитель
    x86insn_int_mul,            // первый параметр - псевдорегистр дл€ EAX, второй - множитель
    x86insn_int_div,            // первый параметр - псевдорегистр дл€ EAX, второй - делитель
    x86insn_int_sal,
    x86insn_int_sar,
    x86insn_int_shl,
    x86insn_int_shr,
