...
; end of inline function fabs
	...
	fstp	st
	seta	byte11
	movzx	dword97,byte11
	mov	dword154,dword97
; end of inline function eq
	cmp	dword154,0
	jne	label0003
	mov	dword32,4
...
; end of inline function fabs
	...
	fstp	st
	seta	byte14
	movzx	dword109,byte14
	mov	dword154,dword109
; end of inline function eq
	cmp	dword154,0
	jne	label0004
	mov	dword38,5
...
; end of inline function fabs
	...
	fstp	st
	seta	byte17
	movzx	dword121,byte17
	mov	dword154,dword121
; end of inline function eq
	cmp	dword154,0
	jne	label0005
	mov	dword43,6
...
; end of inline function fabs
	...
	fstp	st
	seta	byte20
	movzx	dword133,byte20
	mov	dword154,dword133
; end of inline function eq
	cmp	dword154,0
	jne	label0006
	mov	dword49,7
...
; end of inline function fabs
	...
	fstp	st
	seta	byte23
	movzx	dword145,byte23
	mov	dword154,dword145
; end of inline function eq
	cmp	dword154,0
	jne	label0007
	mov	dword55,8
