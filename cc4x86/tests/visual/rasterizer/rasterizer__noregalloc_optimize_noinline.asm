...
label0001:
        ...
        imul    dword14,24
        mov     dword16,dword114
        add     dword16,dword14
        cmp     dword16,dword112
        jle     label0002
        push_all
        push_arg        dword115,4
        push_arg        dword111,4
        ...
        comiss  sse3,sse1
        ja      label0003
        mov     dword36,[dword113+192]
        inc     dword ptr [dword113+192]
        imul    dword36,24
...
label0005:
        ...
        push_arg        dword69,4
        push_arg        dword111,4
        mov     dword75,[dword113+192]
        imul    dword75,24
        mov     dword77,dword113
        add     dword77,dword75
        push_arg        dword77,4
        call    _vec4f_add
        restore_stack   12
        ...
        push_all
        mov     dword79,16
        add     dword79,dword111
        push_arg        dword79,4
        mov     dword81,16
        add     dword81,dword112
        push_arg        dword81,4
        lea     dword82,[ebp-48]
        push_arg        dword82,4
        ...
        push_arg        dword85,4
        mov     dword87,16
        add     dword87,dword111
        push_arg        dword87,4
        mov     dword91,[dword113+192]
        imul    dword91,24
        mov     dword93,dword113
        add     dword93,dword91
        add     dword93,16
        push_arg        dword93,4
        call    _vec2f_add
...
__rasterize_polygon_4f proc
        ...
        ret
label0000:
        cmp     dword ptr [dword57+192],8
        jle     label0001
        mov     dword ptr ds:[0],0
label0001:
        mov     dword56,0
label0003:
        mov     dword13,[dword57+192]
        cmp     dword13,dword56
        jle     label0004
        push_all
        mov     dword15,dword57
