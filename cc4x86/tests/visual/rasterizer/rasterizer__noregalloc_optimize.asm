...
; start of inline function matrix4f_transform
        ...
        movss   dword ptr [ebp-680],float128
...
; start of inline function _rasterize_horiz_line__unordered
        movss   float122,float25
        movss   float123,float23
        movss   float124,float19
        movss   float125,float13
        movss   float126,float16
        movss   float127,float10
...
; start of inline function _rasterize_horiz_line__unordered
        movss   float122,float51
        movss   float123,float49
        movss   float124,float45
        movss   float125,float39
