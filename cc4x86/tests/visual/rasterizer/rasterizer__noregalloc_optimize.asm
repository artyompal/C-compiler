...
; start of inline function vec4f_assign
        ...
        mov     dword ptr [dword375],1065353216
        mov     dword ptr [dword375+4],0
        mov     dword ptr [dword375+8],0
        mov     dword ptr [dword375+12],1065353216
; end of inline function vec4f_assign
...
; start of inline function vec4f_assign
        ...
        mov     dword ptr [dword375],-1082130432
        mov     dword ptr [dword375+4],0
        mov     dword ptr [dword375+8],0
        mov     dword ptr [dword375+12],1065353216
; end of inline function vec4f_assign
...
; start of inline function _transform_to_screen_space
        ...
        cmp     dword754,0
        jl      label002a
        cmp     dword754,dword ptr [__width]
        jge     label002a
        cmp     dword760,0
        jl      label002a
        cmp     dword760,dword ptr [__height]
        jl      label0029
label002a:
        mov     dword ptr ds:[0],0
label0029:
