...
; start of inline function vec4f_assign
        movss   xmm0,xmm5
        mov     ecx,(offset __clip_z_near_base)
        mov     eax,ecx
        mov     dword ptr [eax],0
