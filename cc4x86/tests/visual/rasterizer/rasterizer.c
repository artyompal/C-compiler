...
void rasterizer_set_color(int color)
{
    _color          = color;
}
...
{
    _texture_data   = (int *) texture_data;
...
{
    int *pixel, *line_end, src_color, res_color, green, blue, dst_color, dst_green, dst_blue, int_alpha;
    float float_alpha;
    ...
    pixel       = ((int *)(_videomem + _pitch * y)) + x1;
    line_end    = pixel + x2 - x1;
