...
label0003:
        movss   xmm4,dword ptr [ebp+20]
        addss   xmm4,dword ptr [ebp+28]
        movss   xmm5,dword ptr [ebp+24]
        addss   xmm5,dword ptr [ebp+32]
        mov     edx,[ebp-4]
        add     edx,4
        cmp     edx,[ebp-8]
        mov     [ebp-4],edx
...
; start of inline function _rasterize_triangle_1i
        ...
        mov     [ebp-448],edx
        mov     [ebp-444],ebx
        movss   dword ptr [ebp-432],xmm6
        movss   dword ptr [ebp-428],xmm7
        jge     label001c
        mov     ecx,[ebp-452]
        cmp     ecx,[ebp-456]
        jle     label001d
...
; start of inline function _rasterize_horiz_line__unordered
        ...
        mov     [ebp-420],ecx
        mov     [ebp-416],edx
        movss   dword ptr [ebp-412],xmm7
        movss   dword ptr [ebp-408],xmm1
        movss   dword ptr [ebp-404],xmm2
        movss   dword ptr [ebp-400],xmm3
        movss   dword ptr [ebp-396],xmm6
        movss   dword ptr [ebp-392],xmm5
        jg      label0013
