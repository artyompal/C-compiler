...
; start of inline function _rasterize_horiz_line__unordered
	movss	xmm5,dword ptr [ebp-388]
	movss	xmm4,dword ptr [ebp-384]
	movss	dword ptr [ebp-400],xmm6
	movss	dword ptr [ebp-404],xmm7
