...
# generate XML
run("cc4x86.exe --sse2 --debug-xml-dump --debug-disable-codegen ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");

# generate very unoptimized listing
run("cc4x86.exe --sse2 --debug-disable-basic-opt --debug-disable-regalloc --output-file-name ..\\..\\tests\\visual\\rasterizer\\rasterizer__raw.asm ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");

# generate unoptimized listing
run("cc4x86.exe --sse2 --debug-disable-regalloc --output-file-name ..\\..\\tests\\visual\\rasterizer\\rasterizer__unoptimized.asm ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");

# generate optimized listing with pseudo-registers
run("cc4x86.exe --sse2 --optimize --debug-disable-regalloc --output-file-name ..\\..\\tests\\visual\\rasterizer\\rasterizer__pseudo_registers.asm ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");
...
run("cc4x86.exe --sse2 --optimize --no-inline --output-file-name ..\\..\\tests\\visual\\rasterizer\\rasterizer__no_inline.asm ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");
