...
# generate XML
run("cc4x86.exe --debug-xml-dump --debug-disable-codegen ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");

# generate very unoptimized listing
run("cc4x86.exe --debug-disable-basic-opt --debug-disable-regalloc --output-file-name ..\\..\\tests\\visual\\rasterizer\\rasterizer__raw.asm ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");

# generate unoptimized listing
run("cc4x86.exe --debug-disable-regalloc --output-file-name ..\\..\\tests\\visual\\rasterizer\\rasterizer__unoptimized.asm ..\\..\\tests\\visual\\rasterizer\\rasterizer.c");
